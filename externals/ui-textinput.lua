...
local function OnEditFocusGained(self) self.placeholder:Hide() end

local function ShowPlaceholderIfEmpty(self) if self:GetText() == "" then self.placeholder:Show() end end
