...
local function OnHide() if StackSplitFrame:IsVisible() then StackSplitFrame:Hide() end end

local function PopoutSplitStack(self, qty) ns.Purchase(self:GetParent():GetID(), qty) end
