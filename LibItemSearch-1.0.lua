...
function ItemSearch:FindTypedSearch(itemLink, search)
    ...
    return self:GetTypedSearch('itemTypeGeneric'):findItem(itemLink, search) or
               self:GetTypedSearch('itemName'):findItem(itemLink, search)
end
...
local tooltipScanner = _G['LibItemSearchTooltipScanner'] or
                           CreateFrame('GameTooltip', 'LibItemSearchTooltipScanner', UIParent, 'GameTooltipTemplate')
